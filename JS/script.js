let typed = new Typed(".changing-text", {
    ...
    onStringTyped: function (arrayPos, self) {
      if (self.strings[arrayPos] === "Creative Coder") {
        document.querySelector(".part-2").textContent = "Psst... How's your day today?";
        setTimeout(function () {
          document.querySelector(".part-2").innerHTML = "<h3 class='part-2'>I'm a <span class='changing-text'></span></h3>";
          typed.destroy();
